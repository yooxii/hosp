    ...
    ?><div style='width: fit-content; margin: auto;'>
        ...
        <form id='regform' action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>' target="reg_iframe" method='post'>
            <table border='1px'>
                ...
                <tr>
                    <td>*性别</td>
                    <td><select name='gender' style='width: 100%; padding: 5px;'>
                ...
                <tr>
                    <td>*用户权限</td>
                    <td><select name='usertype' style='width: 100%; padding: 5px;'>
                ...
                <tr>
                    <td colspan='2' style='text-align: center;'><input type='submit' onclick=" regtest()" value='注册' style='width: fit-content; padding: 5px;'></td>
                </tr>
            </table>
        </form>
    </div><?php
